...
import { isCsvFile, isTabular, getCurrentViewColumn, debugLog, partitionString, debounce } from './util';
 ...
 */
export const editorUriScheme = 'csv-tabular-edit'
...
export function activate(context: vscode.ExtensionContext) {
  ...
  const editCsvWithConfigCommand = vscode.commands.registerCommand('edit-csv-tabular.editWithConfig', (overwriteConfigObj: EditCsvConfigOverwrite | undefined) => {
...
function createNewTabularEditorInstance(context: vscode.ExtensionContext, activeTextEditor: vscode.TextEditor, instanceManager: InstanceManager, overwriteSettings: EditCsvConfigOverwrite | null = null): void {
